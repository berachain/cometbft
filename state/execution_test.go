...
// Mock Application to test that [BlockExecutor.ProcessProposal] sets the correct
// NextProposerAddress in ProcessProposalRequest. We must implement all methods of
// the abci.Application interface, even though we only need ProcessProposal.
//
...
func (mockProposalApp) PrepareProposal(
	context.Context,
...
func (app *mockProposalApp) ProcessProposal(
	_ context.Context,
