...
func TestCreateProposalBlockNextProposerAddress(t *testing.T) {
	const height = 2
	...
	var (
		wantNextProposerAddr = []byte(state.NextValidators.GetProposer().Address)
		gotNextProposerAddr  = app.NextProposerAddress
	)
	require.Equal(t, wantNextProposerAddr, gotNextProposerAddr)
}
...
// Mock Application for testing that CreateProposalBlock sets the correct
// NextProposerAddress in PrepareProposalRequest. We must implement all methods of
// the abci.Application interface, even though we only need PrepareProposal.
//
// We can’t use abcimocks.Application because it doesn’t have the
// NextProposerAddress field we need to test. Adding it manually would be a hack,
// as that mock is automatically generated by mockery. The next time someone runs
// mockery, the NextProposerAddress field would be removed.
type mockProposalApp struct {
	NextProposerAddress []byte
}

var _ abci.Application = (*mockProposalApp)(nil)

func (mockProposalApp) Info(
	context.Context,
	*abci.InfoRequest,
) (*abci.InfoResponse, error) {
	return nil, nil
}

func (mockProposalApp) Query(
	context.Context,
	*abci.QueryRequest,
...
func (mockProposalApp) InitChain(
	context.Context,
...
func (app *mockProposalApp) PrepareProposal(
	_ context.Context,
...
func (mockProposalApp) ProcessProposal(
	context.Context,
...
func (mockProposalApp) FinalizeBlock(
	context.Context,
...
func (mockProposalApp) ExtendVote(
	context.Context,
...
func (mockProposalApp) VerifyVoteExtension(
	context.Context,
...
func (mockProposalApp) ListSnapshots(
	context.Context,
...
func (mockProposalApp) OfferSnapshot(
	context.Context,
...
func (mockProposalApp) LoadSnapshotChunk(
	context.Context,
...
func (mockProposalApp) ApplySnapshotChunk(
	context.Context,
