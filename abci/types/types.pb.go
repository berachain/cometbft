...
type RequestProcessProposal struct {
	...
	// next height (also the proposer at round 1 of the current height if consensus
	// goes into multiple rounds).
...
func (m *RequestProcessProposal) GetNextProposerAddress() []byte {
	if m != nil {
		return m.NextProposerAddress
	}
	return nil
}
...
func (m *RequestFinalizeBlock) GetSyncingToHeight() int64 {
	if m != nil {
...
type ValidatorUpdate struct {
	...
	// Berachain: the bera-v1.x line encodes the public key as raw bytes plus a
	// key type (pub_key instead being reserved there). Both forms are accepted
	// when decoding, and both are written to the state store, so that
	// FinalizeBlock responses persisted by either line can be read by the other
	// (e.g. a rolling upgrade or rollback while the last block's response is
	// needed for crash recovery, or /block_results for historical heights).
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
func (m *RequestProcessProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NextProposerAddress) > 0 {
		i -= len(m.NextProposerAddress)
		copy(dAtA[i:], m.NextProposerAddress)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.NextProposerAddress)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.ProposerAddress) > 0 {
...
func (m *ResponseFinalizeBlock) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n53, err53 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(m.NextBlockDelay, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(m.NextBlockDelay):])
	if err53 != nil {
		return 0, err53
	}
	i -= n53
...
func (m *RequestProcessProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextProposerAddress", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NextProposerAddress = append(m.NextProposerAddress[:0], dAtA[iNdEx:postIndex]...)
			if m.NextProposerAddress == nil {
				m.NextProposerAddress = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
